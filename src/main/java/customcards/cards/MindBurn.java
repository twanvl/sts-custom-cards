...
public class MindBurn extends CustomCard {
	...
	public MindBurn() {
        super(ID, NAME, IMAGE, COST, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
        this.exhaust = true;
	}
